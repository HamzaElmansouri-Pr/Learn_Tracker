        ...
        <div class="bg-white rounded-2xl shadow-xl hover-lift p-6 border-l-4 border-indigo-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-4xl font-bold text-gray-900 mt-2"><?php echo e($completionRate); ?>%</p>
                </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl hover-lift p-6 border-l-4 border-green-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-4xl font-bold text-gray-900 mt-2"><?php echo e($sessionsThisWeek); ?>/<?php echo e($totalSessionsThisWeek); ?></p>
                </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl hover-lift p-6 border-l-4 border-purple-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-4xl font-bold text-gray-900 mt-2"><?php echo e($sessionCompletionRate); ?>%</p>
                </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl hover-lift p-6 border-l-4 border-red-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-4xl font-bold text-gray-900 mt-2"><?php echo e($priorityStats['high']); ?></p>
                </div>
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="text-center p-8 bg-gradient-to-br from-red-50 to-pink-50 rounded-xl border-2 border-red-200 hover-lift">
                    <div class="text-5xl font-bold text-red-600 mb-2"><?php echo e($priorityStats['high']); ?></div>
                ...
                <div class="text-center p-8 bg-gradient-to-br from-yellow-50 to-orange-50 rounded-xl border-2 border-yellow-200 hover-lift">
                    <div class="text-5xl font-bold text-yellow-600 mb-2"><?php echo e($priorityStats['medium']); ?></div>
                ...
                <div class="text-center p-8 bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl border-2 border-green-200 hover-lift">
                    <div class="text-5xl font-bold text-green-600 mb-2"><?php echo e($priorityStats['low']); ?></div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php $__currentLoopData = $weeklyStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $week): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-blue-50 transition-colors">
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900"><?php echo e($week['week']); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600"><?php echo e($week['created']); ?></td>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php $__currentLoopData = $monthlyStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $month): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-pink-50 transition-colors">
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900"><?php echo e($month['month']); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600"><?php echo e($month['created']); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="px-3 py-1 text-sm font-semibold rounded-full bg-gradient-to-r from-green-100 to-emerald-100 text-green-800">
                                        <?php echo e($month['completed']); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\profa\OneDrive\Desktop\tracker\cursor\resources\views/statistics/index.blade.php ENDPATH**/ ?>