...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Learning Tracker'); ?></title>
            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="hidden sm:ml-8 sm:flex sm:space-x-4">
                        <a href="<?php echo e(route('dashboard')); ?>" class="inline-flex items-center px-4 py-2 rounded-lg text-sm font-semibold transition-all duration-200 <?php echo e(request()->routeIs('dashboard') ? 'bg-gradient-to-r from-purple-500 to-pink-500 text-white shadow-lg shadow-purple-500/50' : 'text-gray-700 hover:bg-purple-50 hover:text-purple-600'); ?>">
                            🏠 Dashboard
                        </a>
                        <a href="<?php echo e(route('learning-items.index')); ?>" class="inline-flex items-center px-4 py-2 rounded-lg text-sm font-semibold transition-all duration-200 <?php echo e(request()->routeIs('learning-items.*') ? 'bg-gradient-to-r from-blue-500 to-cyan-500 text-white shadow-lg shadow-blue-500/50' : 'text-gray-700 hover:bg-blue-50 hover:text-blue-600'); ?>">
                            📖 Learning Items
                        </a>
                        <a href="<?php echo e(route('exams.index')); ?>" class="inline-flex items-center px-4 py-2 rounded-lg text-sm font-semibold transition-all duration-200 <?php echo e(request()->routeIs('exams.*') ? 'bg-gradient-to-r from-orange-500 to-red-500 text-white shadow-lg shadow-orange-500/50' : 'text-gray-700 hover:bg-orange-50 hover:text-orange-600'); ?>">
                            📝 Exams
                        </a>
                        <a href="<?php echo e(route('calendar.index')); ?>" class="inline-flex items-center px-4 py-2 rounded-lg text-sm font-semibold transition-all duration-200 <?php echo e(request()->routeIs('calendar.*') ? 'bg-gradient-to-r from-green-500 to-emerald-500 text-white shadow-lg shadow-green-500/50' : 'text-gray-700 hover:bg-green-50 hover:text-green-600'); ?>">
                            📅 Calendar
                        </a>
                        <a href="<?php echo e(route('statistics.index')); ?>" class="inline-flex items-center px-4 py-2 rounded-lg text-sm font-semibold transition-all duration-200 <?php echo e(request()->routeIs('statistics.*') ? 'bg-gradient-to-r from-indigo-500 to-purple-500 text-white shadow-lg shadow-indigo-500/50' : 'text-gray-700 hover:bg-indigo-50 hover:text-indigo-600'); ?>">
                            📊 Statistics
                        </a>
                    </div>
                </div>
...
<?php /**PATH C:\Users\profa\OneDrive\Desktop\tracker\cursor\resources\views/layouts/app.blade.php ENDPATH**/ ?>